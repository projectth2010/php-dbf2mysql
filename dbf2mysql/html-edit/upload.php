...
if (isset($_POST["submit"])) {
    ...
    if (isset($_FILES["file"]) && $_FILES["file"]["error"] == 0) {
        ...
        $_SESSION['dbfPath'] = "dbf/" . time() . "_" . $_FILES['file']['name'];
        move_uploaded_file($fileTmpName, $_SESSION['dbfPath']);
...
<body>
    ...
    <?php if (isset($_POST["submit"])) : ?>
        ...
        <a href="import.php?filename=<?php echo $_SESSION['dbfPath']; ?>&tablename=<?php echo $tableName; ?>">Next Step - Import Data</a>
    <?php endif; ?>
